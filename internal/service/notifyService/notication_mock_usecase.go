...
func (m *MockNotificationService) MarkAllRead(ctx context.Context, req *dto.MarkAsReadRequest) (*dto.MarkAsReadResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MarkAllRead", ctx, req)
...
func (mr *MockNotificationServiceMockRecorder) MarkAsRead(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkAllRead", reflect.TypeOf((*MockNotificationService)(nil).MarkAllRead), ctx, req)
}

// RegisterNeUserDevice mocks base method.
func (m *MockNotificationService) RegisterNewUserDevice(ctx context.Context, req *dto.RegisterNewDevice) (*dto.RegisterNewDeviceResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterNewUserDevice", ctx, req)
	ret0, _ := ret[0].(*dto.RegisterNewDeviceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RegisterNeUserDevice indicates an expected call of RegisterNeUserDevice.
func (mr *MockNotificationServiceMockRecorder) RegisterNeUserDevice(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterNewUserDevice", reflect.TypeOf((*MockNotificationService)(nil).RegisterNewUserDevice), ctx, req)
}
